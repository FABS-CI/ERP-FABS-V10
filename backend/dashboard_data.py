...
_ALL_KPIS = {
    ...
    "proformas_generees": {
        "key": "proformas_generees",
        "label": "Proformas générées (mois)",
        "value": 15,
        "suffix": "",
        "icon": "FileText",
        "accent": "#0A2540",
    ...
    "proformas_envoyees": {
        "key": "proformas_envoyees",
        "label": "Proformas envoyées (mois)",
        "value": 12,
        "suffix": "",
        "icon": "Send",
        "accent": "#2E7D32",
    ...
    "factures_envoyees": {
        "key": "factures_envoyees",
        "label": "Factures envoyées (mois)",
        "value": 28,
        "suffix": "",
        "icon": "FileText",
        "accent": "#2E7D32",
    ...
    "bl_envoyes": {
        "key": "bl_envoyes",
        "label": "Bons de livraison envoyés (mois)",
        "value": 18,
        "suffix": "",
        "icon": "Truck",
        "accent": "#0A2540",
...
ROLE_KPIS: Dict[str, List[str]] = {
    "super_admin":           ["ca_mois", "factures_impayees", "paiements_mois", "commandes_en_cours", "proformas_generees", "envois_whatsapp"],
    "directeur_general":     ["ca_mois", "factures_impayees", "paiements_mois", "commandes_en_cours", "proformas_generees", "envois_whatsapp"],
    "directeur_commercial":  ["ventes_mois", "top_clients_count", "commandes_en_cours", "proformas_envoyees", "factures_envoyees", "envois_whatsapp"],
    "comptable":             ["ca_mois", "factures_impayees", "paiements_mois", "creances_total", "factures_envoyees", "envois_email"],
    "gestionnaire_stock":    ["alertes_stock", "mouvements_recents", "ruptures", "livraisons_jour", "bl_envoyes"],
    "responsable_magasinier":["alertes_stock", "commandes_en_cours", "ruptures", "livraisons_jour", "bl_envoyes"],
    "secretariat":           ["commandes_en_cours", "top_clients_count", "proformas_generees", "envois_email"],
    "service_logistique":    ["bl_assignes", "bl_en_route", "bl_livrees_jour", "bl_envoyes", "livraisons_jour"],
    "commercial":            ["ventes_mois", "top_clients_count", "commandes_en_cours", "proformas_envoyees", "envois_whatsapp"],
    "responsable_rh":        ["total_employes", "employes_actifs", "conges_en_attente", "contrats_expirant"],
}

...
const ClientSchema = z.object({
  ...
  type_client: z.enum([
    "librairie", "lycee", "college", "groupe_scolaire", "epp", "iep",
    "catholique", "methodiste", "particulier", "distributeur", "representant",
    "memo", "inspecteur", "dren", "up", "institut", "ecole", "autre",
  ]),
